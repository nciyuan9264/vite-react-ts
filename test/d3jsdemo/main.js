...
const renderGraph = ()=> {
    ...
    //设置连接线
    edges_line = svg.append("g").selectAll("g")
        .data(links) //此时的links属性已经经过力学仿真进行了相关数据修改
        .enter()
        .append("path")
        .attr("marker-end", function (_d, i) {
